        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-8xl lg:max-w-none">
            <div className="flex justify-between md:flex-row flex-col">
              ...
              <p className="mt-4 md:text-right max-w-1/2 lg:max-w-[50%] text-2xl leading-8 text-zinc-400">
            ...
            <dl className="mt-16 grid grid-cols-1 gap-2 text-center sm:grid-cols-2 lg:grid-cols-5 lg:gap-x-2">
